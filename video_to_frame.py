...
print(video_name)
os.makedirs(r'C:\\Users\\datng\\Google Drive\\pPlayground\\cornhack2019\\images\\%s\\'%(video_name),exist_ok=True)
count = 0
while(video.isOpened()):
	...
	cv2.imwrite(r"C:\\Users\\datng\\Google Drive\\pPlayground\\cornhack2019\\images\\%s\\frame%d.jpg"%(video_name, count) , frame)
	count += 1 
